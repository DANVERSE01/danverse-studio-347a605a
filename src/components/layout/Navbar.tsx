        ...
        >
          ...
          <div className="flex items-center gap-6">
            <a href="#contact" onClick={(e) => { e.preventDefault(); scrollTo('#contact'); }}
              className="premium-btn hidden md:flex items-center gap-2 font-mono-brand text-[9px] uppercase tracking-[0.25em] glass-btn rounded-full px-5 py-2.5 transition-all duration-500 hover:shadow-[0_0_20px_hsl(var(--rose-gold)/0.1)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
