    ...
    >
      ...
      <div className="absolute top-1/2 right-8 md:right-16 -translate-y-1/2 pointer-events-none select-none">
        <span
          ...
          style={{
            ...
            WebkitTextStroke: '2px hsl(0 0% 0% / 0.08)',
      ...
      <motion.div ref={inViewRef} variants={staggerContainer} initial="hidden" animate={isInView ? 'visible' : 'hidden'} className="mb-24">
        ...
        <motion.h2 variants={fadeUp} className="flex items-baseline gap-3 md:gap-5 flex-wrap">
          <span className="font-script italic font-light tracking-[0.01em]" style={{ fontSize: 'var(--text-section)', color: 'hsl(35 30% 88%)' }}>
            How we
          </span>
          <span className="font-display-alt font-extrabold uppercase tracking-[-0.04em]" style={{
            fontSize: 'clamp(3rem, 8vw, 8rem)',
            WebkitTextStroke: '2px hsl(35 30% 88% / 0.5)',
            WebkitTextFillColor: 'transparent',
          }}>
            THINK
          </span>
  ...
  return (
    ...
    >
      <div className="flex md:flex-col items-baseline md:items-start gap-3">
        <span className="font-script italic text-5xl md:text-6xl transition-colors duration-500" style={{ color: 'hsl(35 30% 88% / 0.2)' }}>
          {phase.num}
        </span>
        <span className="font-mono-brand text-[9px] uppercase tracking-[0.25em]" style={{ color: 'hsl(35 30% 88% / 0.7)' }}>
          {phase.label}
        </span>
      </div>

      <div>
        <h3 className="font-script italic text-2xl md:text-3xl leading-[1.2] transition-colors duration-500 group-hover:text-white" style={{ color: 'hsl(35 30% 88% / 0.8)' }}>
          {phase.title}
        </h3>
        <p className="text-[12px] leading-[1.9] mt-3 max-w-sm" style={{ color: 'hsl(35 30% 88% / 0.4)' }}>
          {phase.description}
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="font-mono-brand text-[9px] tracking-[0.2em] uppercase" style={{ color: 'hsl(35 30% 88% / 0.25)' }}>
          {phase.duration}
        </span>
      </div>
    </motion.div>
